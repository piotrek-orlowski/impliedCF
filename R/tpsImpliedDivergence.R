...
#' @param bootstrap boolean, FALSE by default. If TRUE, model parameters are simulated from the posterior distribution of the smoother and divergences are recalculated at varying parameter values; this allows for, e.g., Bayesian credible interval calculation.
#' @param Nrepl number of bootstrap replications
...
tpsImpliedDivergence <- function(option.panels,mkt.frame,u.t.mat, L = NULL, U = NULL, bootstrap = F, Nrepl = 1e3, ...) {
